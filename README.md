...
```
### Output:
<img width="727" height="516" alt="image" src="https://github.com/user-attachments/assets/48b2f9ed-10f3-493d-8fe9-c59129625a9e" />

## Result:
  Thus, the python program that remove two string values from the rear end of the list is executed successfully.

## EX 10 (C) Stack Implementation Using `LifoQueue` (Max Size 7) 
...
```
## Output
<img width="411" height="468" alt="image" src="https://github.com/user-attachments/assets/0e8596c4-921d-40ed-be78-baab3a4611ef" />
...
# EX 10 (E) Types of Queue-Circular Queue in Python
